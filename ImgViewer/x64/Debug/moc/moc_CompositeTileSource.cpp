...
QT_MOC_LITERAL(6, 68, 15), // "sourceReordered"
QT_MOC_LITERAL(7, 84, 20), // "handleTileRetriecved"
...
QT_MOC_LITERAL(11, 111, 17) // "clearPendingTiles"
    ...
    "sourceReordered\0handleTileRetriecved\0"
...
void CompositeTileSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sourceReordered(); break;
        case 4: _t->handleTileRetriecved((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< quint32(*)>(_a[2])),(*reinterpret_cast< quint8(*)>(_a[3]))); break;
        ...
        {
            using _t = void (CompositeTileSource::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CompositeTileSource::sourceReordered)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CompositeTileSource::staticMetaObject = { {
    ...
    qt_meta_stringdata_CompositeTileSource.data,
    qt_meta_data_CompositeTileSource,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 3
void CompositeTileSource::sourceReordered()
{
