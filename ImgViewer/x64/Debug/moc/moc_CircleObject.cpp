...
struct qt_meta_stringdata_CircleObject_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CircleObject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CircleObject_t qt_meta_stringdata_CircleObject = {
    {
QT_MOC_LITERAL(0, 0, 12) // "CircleObject"
...
QT_INIT_METAOBJECT const QMetaObject CircleObject::staticMetaObject = { {
    QMetaObject::SuperData::link<MapGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_CircleObject.data,
    qt_meta_data_CircleObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CircleObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CircleObject.stringdata0))
