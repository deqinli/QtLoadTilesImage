...
struct qt_meta_stringdata_OSMTileSource_t {
    QByteArrayData data[3];
    char stringdata0[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OSMTileSource_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OSMTileSource_t qt_meta_stringdata_OSMTileSource = {
    {
QT_MOC_LITERAL(0, 0, 13), // "OSMTileSource"
QT_MOC_LITERAL(1, 14, 28), // "handleNetworkRequestFinished"
QT_MOC_LITERAL(2, 43, 0) // ""

    },
    "OSMTileSource\0handleNetworkRequestFinished\0"
    ""
};
...
void OSMTileSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OSMTileSource *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject OSMTileSource::staticMetaObject = { {
    QMetaObject::SuperData::link<TileSource::staticMetaObject>(),
    qt_meta_stringdata_OSMTileSource.data,
    qt_meta_data_OSMTileSource,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OSMTileSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OSMTileSource.stringdata0))
